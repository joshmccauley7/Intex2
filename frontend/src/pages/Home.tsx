    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <section className="bg-white py-12 px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-50 rounded-xl p-8 text-center border border-slate-100">
            ...
            <div className="text-sm text-slate-500 font-medium">Safe Homes</div>
          </div>
          <div className="bg-slate-50 rounded-xl p-8 text-center border border-slate-100">
            <Shield className="mx-auto mb-3 text-safira-blue" size={28} />
            <div className="text-4xl font-bold text-navy-DEFAULT mb-1">8</div>
      ...
      <section className="bg-slate-50 py-16 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-navy-DEFAULT mb-4">Our Mission</h2>
          <p className="text-slate-600 leading-relaxed">
            Safira exists to rescue, shelter, and rehabilitate children who have suffered sexual abuse in Brazil.
            We provide safe housing, trauma-informed care, educational support, and legal advocacy —
      ...
      <section className="bg-white py-16 px-6 text-center">
        <h2 className="text-3xl font-bold text-navy-DEFAULT mb-4">See the Impact Your Support Makes</h2>
