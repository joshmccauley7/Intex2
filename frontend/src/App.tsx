...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      {/* Hero */}
      <section
        className="relative text-white text-center py-36 px-6 bg-cover"
        style={{ backgroundImage: `url(${heroImg})`, backgroundPosition: 'center 30%' }}
      >
        <div className="absolute inset-0 bg-black/60" />
        <div className="relative z-10 max-w-2xl mx-auto px-6 py-10 rounded-2xl"
          style={{ background: 'rgba(0,0,0,0.35)', backdropFilter: 'blur(6px)', WebkitBackdropFilter: 'blur(6px)' }}
        >
          <h1
            className="text-5xl md:text-6xl font-bold leading-tight mb-4 text-white hero-animate"
            style={{ textShadow: '0 2px 16px rgba(0,0,0,0.7)' }}
          >
            Every Child Deserves Safety
          </h1>
          <p className="text-lg text-white/95 mb-8 leading-relaxed hero-animate-delay"
